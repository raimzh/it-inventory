...
export class AssetsService {
  ...
  /**
   * Мягкое удаление: карточка исчезает из выборок, но остаётся в базе вместе
   * с историей изменений. Раньше удаление было жёстким и уносило историю
   * каскадом — восстановить, что происходило с оборудованием, было нельзя.
   *
   * Побочный плюс: пропала ошибка внешнего ключа, когда ОС уже участвует
   * в инвентаризации — связанные записи больше не мешают удалению.
   */
